...
export default function EnvironmentalPolicy() {
  ...
  const quizQuestions = [
    {
      question: "What is the primary purpose of environmental policy?",
      options: [
      ...
      correct: 1,
      explanation: "Environmental policy aims to protect natural resources and human health through sustainable practices and regulations."
    },
    {
      ...
      correct: 1,
      explanation: "The Paris Agreement is the main international treaty on climate change, aiming to limit global warming."
    },
    {
      ...
      options: [
        ...
        "Private sector initiatives only",
        "International treaties only"
      ],
      correct: 1,
      explanation: "Environmental governance involves collaborative decision-making between governments, businesses, communities, and other stakeholders."
    }
  ];
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8 animate-slide-up">
          ...
          <h1 className="text-4xl font-bold text-foreground mb-4">
            {t('advanced.environmental.title')}
          </h1>
                ...
                <Card className="shadow-card mb-6">
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
                      ...
                      <span>{t('advanced.environmental.video.title')}</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="relative rounded-lg overflow-hidden h-64 mb-4">
                      <img 
                        src={environmentalPolicyImg} 
                      ...
                      <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                        <div className="text-center text-white">
                          ...
                          <h3 className="text-xl font-semibold mb-2">{t('advanced.environmental.title')}</h3>
            ...
            <Card className="shadow-card">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  {t('advanced.environmental.content.overview')}
                </p>

                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    <h4 className="font-semibold mb-2">{t('advanced.environmental.content.topics.title')}</h4>
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>• {t('advanced.environmental.content.topics.1')}</li>
                      <li>• {t('advanced.environmental.content.topics.2')}</li>
                      <li>• {t('advanced.environmental.content.topics.3')}</li>
                      <li>• {t('advanced.environmental.content.topics.4')}</li>
                      <li>• {t('advanced.environmental.content.topics.5')}</li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">{t('advanced.environmental.content.outcomes.title')}</h4>
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>• {t('advanced.environmental.content.outcomes.1')}</li>
                      <li>• {t('advanced.environmental.content.outcomes.2')}</li>
                      <li>• {t('advanced.environmental.content.outcomes.3')}</li>
                      <li>• {t('advanced.environmental.content.outcomes.4')}</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="shadow-card">
              ...
              <CardContent>
                <div className="grid gap-3">
                  {[
                    t('advanced.environmental.facts.1'),
                    t('advanced.environmental.facts.2'),
                    t('advanced.environmental.facts.3'),
                    t('advanced.environmental.facts.4'),
                    t('advanced.environmental.facts.5')
                  ].map((fact, index) => (
